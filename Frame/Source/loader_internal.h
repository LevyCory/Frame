...
/**********************************************************************************************************************
	Macro		:	FRAME_PROC_REFERENCE
	Purpose		:	
	Parameters	:	@ parameter - Description
**********************************************************************************************************************/
#define FRAME_PROC_REFERENCE(ptThunkData) (LPSTR)((0 == 0xff00 & ptThunkData->u1.Ordinal) ? ptThunkData->u1.Ordinal :\
	ADD_POINTERS(hDll, ptThunkData->u1.AddressOfData))
